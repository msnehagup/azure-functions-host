...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class KeysControllerTests : IDisposable
    {
        ...
        public KeysControllerTests()
        {
            ...
            _functionsSyncManagerMock.Setup(p => p.TrySyncTriggersAsync()).ReturnsAsync((true, null));
        ...
        public async Task PutKey_NotAFunction_ReturnsNotFound()
        {
            ...
            _functionsSyncManagerMock.Verify(p => p.TrySyncTriggersAsync(), Times.Never);
        }
        ...
        public async Task PutKey_Succeeds()
        {
            ...
            _functionsSyncManagerMock.Verify(p => p.TrySyncTriggersAsync(), Times.Once);
        }
